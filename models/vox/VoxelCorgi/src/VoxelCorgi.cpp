...
string dataSet[8][16][16] = {
  ...
  },
  {
    ...
    { "--","--","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","--","--","--" },
    { "--","--","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","--","--","--" },
    { "--","--","BR","BR","BR","BR","BR","BR","WH","WH","WH","BR","BR","--","--","--" },
    { "--","WH","BR","WH","WH","WH","WH","WH","WH","--","BR","BR","WH","WH","--","--" },
    { "WH","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--" },
    { "--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--" },
    { "--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--" }
  },
  {
    ...
    { "--","--","--","--","--","--","--","--","--","--","BR","BR","BR","--","--","--" },
    { "--","--","--","--","--","--","--","--","--","BR","BR","BR","BR","--","--","--" },
    { "--","--","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","WH","BK" },
    { "--","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","WH","--" },
    { "--","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","WH","WH","--","--" },
    { "--","WH","BR","BR","BR","BR","BR","BR","BR","BR","BR","BR","WH","--","--","--" },
    { "--","WH","BR","BR","BR","BR","BR","BR","WH","WH","WH","BR","WH","--","--","--" },
...
int main( int argc, char* argv[] ) {
	string strFileName = "VoxelCorgi.vox";
	ofstream file;
